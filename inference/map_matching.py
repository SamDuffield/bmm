...
def induce_subgraph_within_distance(graph, polyline, distance=v_max*15/2):
    """
    ...
    for coord in polyline:
        ...
        node_subset = list(set(node_subset + df[distances < distance].index.to_list()))
