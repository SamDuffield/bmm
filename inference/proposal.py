...
from inference.model import distance_prior, default_d_max, pdf_gamma_mv, cdf_gamma_mv, intersection_penalisation
...
def auxiliary_distance_proposal(graph, particle, new_observation, time_interval, gps_sd,
