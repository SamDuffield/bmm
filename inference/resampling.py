...
def full_fixed_lag_stitch(graph, j, fixed_particles, new_particles, pf_weights,
...
def rejection_fixed_lag_stitch(graph, j, fixed_particles, new_particles, adjusted_weights,
                               min_resample_time, stitch_time_interval,
...
def fixed_lag_stitching_rejection(graph, particles, weights, lag, max_rejections=100):
    ...
    for j in range(n):
        ...
        if full_fixed_lag_resample:
            #### Full resampling
            out_particles[j], ess_stitch_track[j] = full_fixed_lag_stitch(graph, j, fixed_particles, new_particles,
                                                                          weights,
                                                                          min_resample_time, stitch_time_interval,
                                                                          min_resample_time_indices,
            ...
            out_particles[j] = rejection_fixed_lag_stitch(graph, j, fixed_particles, new_particles, adjusted_weights,
                                                          min_resample_time, stitch_time_interval,
                                                          min_resample_time_indices,
                                                          distance_prior_bound, max_rejections)
            if out_particles[j] is None:
                out_particles[j] = full_fixed_lag_stitch(graph, j, fixed_particles, new_particles,
                                                         weights,
                                                         min_resample_time, stitch_time_interval,
                                                         min_resample_time_indices,
                                                         originial_stitching_distances,
